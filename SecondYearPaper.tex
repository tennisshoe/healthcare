...
\definecolor{bar}{rgb}{0.471,0.529,0.671}
\definecolor{sections}{rgb}{0.18,0.259,0.447}

\titleformat{\section}[hang]{\Large\bfseries\color{sections}}{\thesection \hspace{1pt} \textcolor{bar}{|} \hspace{1pt}}{0pt}{\Large\bfseries}
\titleformat{\subsection}[hang]{\large\bfseries\color{sections}}{}{0pt}{\large\bfseries}
\titleformat{\subsubsection}[hang]{\normalsize\bfseries\color{sections}}{}{0pt}{\normalsize\bfseries}
...
\multicolumn{5}{l}{\footnotesize  \space according to 2007 Economic Census data. 3 digit NAICS groupings used as fixed effects to}\\
...
\begin{table}[H]
	...
	\input{resources/arts_binary.tex}
	\label{tab:arts}
\end{table}
...
\multicolumn{5}{l}{\footnotesize \space under triple diff model. }\\
\multicolumn{5}{l}{\footnotesize Column (3) restricts the dataset to counties that border other states across Massachusetts, }\\
\multicolumn{5}{l}{\footnotesize \space Connecticut, Vermont, Rhode Island, New Hampshire and New York. 3 digit NAICS level used }\\
\multicolumn{5}{l}{\footnotesize \space for industry fixed effects to enable full fixed effect identification. }\\
\multicolumn{5}{l}{\footnotesize Column (4) uses a synthetic control model that matches each Massachuetts industry by county }\\
\multicolumn{5}{l}{\footnotesize \space pre-trend against US counties with similar income, age, urban and insurance rate characteristics. }\\
