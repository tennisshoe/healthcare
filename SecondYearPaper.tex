...
\end{quote}
The above quote suggests we will see an effect in self-employed consultants but not in high growth startups. More generally, the impact of reform may vary by industry and not just entrepreneur. 

In this paper we explore how enterprises are affected by access to health care. We contribute to the literature in three ways. We first present results that suggest the current ambiguity about the impact of health care on entrepreneurial rates may due to poor control design. We then compare tax-exempt and tax paying industries to provide evidence that the longer term tax implications of short term benefits may not deter marginal entrepreneurship. Finally we contrast industries by capital requirements to show high capital industries disproportionately grow from improved access to health care. 
...
\begin{center}
	\begin{table}[H]
		\centering
		\caption{Model (1) estimator with other New England states as control} 
		\input{resources/prop1_state.tex}	
...
\begin{center}
	\begin{table}[H]
		...
		\input{resources/prop1_synth.tex}	
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.495\textwidth}
		\includegraphics[width=\textwidth]{resources/graphpoint_se_all_basic}
		\caption{Other New England states as control}
	\end{subfigure}
		\begin{subfigure}[b]{0.495\textwidth}
		\includegraphics[width=\textwidth]{resources/graphpoint_se_synth}
